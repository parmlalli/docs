...
<Info>
  SSO (including OIDC providers) is an **Enterprise** feature. If you only see SAML fields in **Settings → SSO**, contact your account team before you invest in OIDC configuration.
</Info>
...
<Steps>
  ...
  <Step title="Set redirect URI">
    Add the **Redirect URI** from Planasonix **Settings → SSO** (OIDC section). The value must match **exactly**, including path and trailing slash if shown.
  </Step>
