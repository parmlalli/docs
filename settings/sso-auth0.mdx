...
Upload Auth0’s **IdP metadata** or paste **SSO URL**, **issuer**, and **signing certificate** into Planasonix. Test login from the Planasonix sign-in page before you cut over users.
