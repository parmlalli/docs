...
<AccordionGroup>
  ...
  <Accordion title="Analytics warehouses and lakehouses">
    For Snowflake, BigQuery, Databricks, or similar, use [Data warehouses](/connections/data-warehouses). Pair with [Cloud storage](/connections/cloud-storage) when you stage files before load.
  </Accordion>
